...
type InspectorTab = "context" | "files" | "memory" | "issues" | "workflows" | "mcp";
...
export default function App() {
  ...
  const inspectProject = async (tab: InspectorTab) => {
    ...
    try {
      ...
      if (tab === "workflows" || tab === "mcp") setProjectData(undefined);
