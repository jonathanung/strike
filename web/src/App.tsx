...
type InspectorTab = "context" | "files" | "memory" | "issues" | "workflows" | "diagnostics";
...
export default function App() {
  ...
  const inspectProject = async (tab: InspectorTab) => {
    ...
    try {
      ...
      if (tab === "workflows" || tab === "diagnostics") setProjectData(undefined);
