...
type InspectorTab = "context" | "files" | "memory" | "issues" | "workflows";
...
export default function App() {
  ...
  const execute = (text: string, attached: ImageAttachment[]) => {
    ...
    switch (resolved.kind) {
      ...
      case "op":
        void op(resolved.type, resolved.data, selectedID);
        return;
    }
  };
  ...
  const inspectProject = async (tab: InspectorTab) => {
    ...
    try {
      ...
      if (tab === "workflows") setProjectData(undefined);
