...
type InspectorTab = "files" | "memory" | "issues" | "workflows";
...
const inspectorTabOrder: InspectorTab[] = ["files", "memory", "issues", "workflows"];
