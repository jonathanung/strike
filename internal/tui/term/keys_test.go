...
func TestEncodeKey(t *testing.T) {
	tests := []struct {
		...
		{name: "shift with caps lock", msg: tea.KeyPressMsg{Code: 'a', Text: "A", Mod: tea.ModShift | tea.ModCapsLock}, want: []byte("A")},
		{name: "shift with num lock", msg: tea.KeyPressMsg{Code: 'A', Text: "A", Mod: tea.ModShift | tea.ModNumLock}, want: []byte("A")},
		{name: "shift with scroll lock", msg: tea.KeyPressMsg{Code: '!', Text: "!", Mod: tea.ModShift | tea.ModScrollLock}, want: []byte("!")},
