...
func TestPaletteContainsOnlySupportedActionsWithStableMetadata(t *testing.T) {
	...
	want := []paletteEntry{
		...
		{ID: "command:sandbox", Label: "/sandbox", Description: "show OS sandbox policy (what is possible vs permissionMode)", Action: paletteAction{Kind: paletteActionBuiltin, Value: "/sandbox"}},
		...
		{ID: "command:ftue", Label: "/ftue", Description: "setup wizard: provider, model, optional init, feature tour, first prompt", Action: paletteAction{Kind: paletteActionBuiltin, Value: "/ftue"}},
