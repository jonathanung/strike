...
func TestPaletteContainsOnlySupportedActionsWithStableMetadata(t *testing.T) {
	...
	want := []paletteEntry{
		...
		{ID: "command:pets", Label: "/pets", Description: "focus agents pane pet; optional name sets focused agent pet", Action: paletteAction{Kind: paletteActionBuiltin, Value: "/pets"}},
		...
		{ID: "command:queue", Label: "/queue", Description: "focus the queue right pane (queued prompts, scheduled loops, pool waits)", Action: paletteAction{Kind: paletteActionBuiltin, Value: "/queue"}},
		...
		{ID: "command:pane", Label: "/pane", Description: "focus a plugin pane by id (or list plugin panes)", Action: paletteAction{Kind: paletteActionBuiltin, Value: "/pane"}},
