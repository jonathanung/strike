...
func paletteBuiltinDisabled(id commandID, availability paletteAvailability) string {
	...
	case commandHelp, commandKeys, commandLegend, commandExit, commandQuit,
		...
		return ""
	case commandVim, commandNano, commandMDRead, commandThink, commandTelemetry, commandExport, commandCopy, commandContext, commandEffectivePrompt, commandCost, commandMCP, commandLSP, commandDiagnostics, commandRename,
