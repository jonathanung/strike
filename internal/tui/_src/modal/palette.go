...
func paletteBuiltinDisabled(id commandID, availability paletteAvailability) string {
	...
	case commandHelp, commandKeys, commandExit, commandQuit,
		...
		return ""
	case commandVim, commandNano, commandMDRead, commandThink, commandTelemetry, commandExport, commandContext, commandEffectivePrompt, commandCost, commandMCP, commandRename,
