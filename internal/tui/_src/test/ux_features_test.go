...
func TestHelpCommandOpensFilterableCatalogModal(t *testing.T) {
	...
	wantLabels := []string{
		"/provider", "/model", "/settings", "/session", "/rename", "/export", "/timeline", "/diag", "/copy", "/theme", "/memory",
		"/issues", "/plan", "/compact", "/fork", "/undo", "/rewind", "/fast", "/think", "/layout", "/md-read", "/keys", "/legend", "/exit", "/quit", "/palette", "/interrupt", "/agent-next", "/focus-left", "/review", "tab",
	}
