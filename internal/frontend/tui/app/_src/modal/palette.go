...
func paletteBuiltinDisabled(id commandID, availability paletteAvailability) string {
	...
	case commandHelp, commandKeys, commandLegend, commandExit, commandQuit,
		...
		return ""
	case commandVim, commandNano, commandConfig, commandMDRead, commandThink, commandTelemetry, commandExport, commandTimeline, commandDiag, commandDiagnostic, commandCopy, commandContext, commandEffectivePrompt, commandCost, commandMCP, commandLSP, commandDiagnostics, commandRename,
