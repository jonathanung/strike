...
**Now:** i5 TB DEV **22/25** with `--dangerously-skip-permissions` (network.allow still written; DSP bypassed it). gcode-to-text resolved. SWE stays `--auto`. Spend ~$459 / $3500.
